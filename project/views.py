    ...
    def get(self, request):
        ...
        return render(
            ...
            "project/projectlist.html",
            {
                ...
                "project_list_list": project_list_list,
    ...
    def get(self, request):
        ...
        if project_list_list:
            ...
            return render(
                request,
                "project/projectlist.html",
                {"project_list": project_list, "error": error},
            )
    ...
    def get(self, request):
        return render(
            ...
            "project/projectlist.html",
            {
                "project_list": project_list,
                "allproject": Project.objects.filter(
                    projectallocation__in=self.request.user.projectallocation_set.all()
                ),
            },
        )
...
class ProjectView(View):
    ...
    def get(self, request):
        ...
        return render(
            request,
            "project/create.html",
            {"form": form, "employee": User.objects.all(), "error": "error"},
        )
    ...
    def post(self, request, **kwargs):
        ...
        if (
            ...
            and request.POST.get("start_date") < request.POST.get("end_date")
        ):
            if Project.objects.filter(name=request.POST.get("name")).count() > 0:
                return render(
                    request,
                    "project/create.html",
                    {"form": form, "error": "error", "employee": User.objects.all()},
                )
            else:
                try:
                ...
                return render(
                    request, "project/create.html", {"form": form, "project": project}
                )
        else:
            return render(
                request,
                "project/create.html",
                {"form": form, "errors": errors, "employee": User.objects.all()},
            )
...
class AssignleaderView(View):
    ...
    def get(self, request):
        ...
        return render(
            request, "project/assignleader.html", {"form": form, "error": "error"}
        )
    ...
    def post(self, request, **kwargs):
        ...
        if (
            ...
            return render(
                request,
                "project/assignleader.html",
                {"form": form, "error": "error", "errors": errors},
            )
    ...
    def form_valid(self, form):
        ...
        if user.percentage + int(mode[3]) > 99:
            if user.percentage == 100:
                ...
                return render(
                    self.request,
                    "project/allocationupdate.html",
                    {"form": form, "error": error},
                )
            error = (
                "Please provide allocation "
                + "less than "
                + str(100 - user.percentage)
                + "."
            )
            return render(
                self.request,
...
class AllocateemployeebyleadView(View):
    ...
    def get(self, request):
        ...
        return render(
            request,
            "project/allocateemployeebylead.html",
            {
                "form": form,
...
class AllocationListforleadView(ListView):
    ...
    def get_queryset(self):
        ...
        return ProjectAllocation.objects.filter(project_id__in=projects).order_by(
            "project_id"
        )
...
class AllocationDeleteforleadView(View):
    ...
    def get(self, request, pk, id, *args, **kwargs):
        ...
        return render(
            request,
            "project/allocationdeleteforlead.html",
            {"allocation": allocation, "employee": employee},
        )
...
class ProjecthealthView(View):
    ...
    def get(self, request):
        ...
        data = [
            ...
            for element1, element2 in zip(result, project_list)
        ]
...
class SortView(View):
    def get(self, request):
        ...
        return render(
            request,
            "project/projectlist.html",
            {"project_list": project_list, "name": name, "q": q},
        )
    ...
    def get(self, request):
        ...
        if projectname and startdate and enddate and status:
            project_list_list = Project.objects.filter(
                ...
                & Q(start_date=datetime.strptime(startdate, "%Y-%m-%d").date())
                & Q(end_date=datetime.strptime(enddate, "%Y-%m-%d").date())
            )
