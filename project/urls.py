...
from .views import (
    ProjectView,
    AssignleaderView,
    AllocateemployeeView,
    AllocateemployeebyleadView,
    ProjectList,
    ProjectUpdateView,
    ProjectDeleteView,
    Projectforlead,
    ...
    AllocationListforleadView,
    AllocationDeleteforleadView,
    AllocationUpdateforleadView,
    Projectforemployee,
    ProjecthealthView,
    SearchView,
    SortView,
...
urlpatterns = [
    ...
    path(
        "projectlistforemployee/",
        Projectforemployee.as_view(),
        name="projectlistforemployee",
    ),
    ...
    path(
        "allocateemployeebylead/",
        AllocateemployeebyleadView.as_view(),
        name="allocateemployeebylead",
    ),
    ...
    path(
        "allocationupdate/<int:id>",
        AllocationUpdateView.as_view(),
        name="allocationupdate",
    ),
    path(
        "allocationdelete/<int:pk>/<int:id>",
        AllocationDeleteView.as_view(),
        name="allocationdelete",
    ),
    path(
        "allocationlistforlead/",
        AllocationListforleadView.as_view(),
        name="allocationlistforlead",
    ),
    path(
        "allocationupdateforlead/<int:id>",
        AllocationUpdateforleadView.as_view(),
        name="allocationupdateforlead",
    ),
    path(
        "allocationdeleteforlead/<int:pk>/<int:id>",
        AllocationDeleteforleadView.as_view(),
        name="allocationdeleteforlead",
    ),
